...
// INTEREST-BASED BRAND (Global Explorer type)
{
  ...
  logo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80',
  primaryColor: '#3D348B',
  ...
  logo: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=80',
  primaryColor: '#5F4B8B',
    ...
    switch (brandId) {
      ...
      case 'global-competitor':
        return {
          ...
          backgroundImage: 'https://images.unsplash.com/photo-1471295253337-46ad1756a187?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80',
          ...
          {!selectedBrand && !isEditing ? <div className="flex flex-col items-center justify-center h-64 text-gray-500">
              ...
              {isEditing ? <div>
                  ...
                  {activeTab === 'experience' && <div className="space-y-6">
                    ...
                    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.6)), url(${formData.experience?.backgroundImage || 'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df'})`
                  }}>

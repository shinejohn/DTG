          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
              {pricingPlans.map((plan) => (
                <div
                  key={plan.id} className={`bg-white rounded-xl shadow-sm border overflow-hidden relative ${plan.popular ? 'ring-2 ring-blue-500' : ''} flex flex-col`}
                >
                  {plan.popular && (
                  ...
                  <div className="p-6">
                    ...
                    <Link
                      to={plan.buttonLink} className={`block w-full py-2 px-4 rounded-md text-center font-medium ${plan.popular ? 'bg-blue-600 text-white hover:bg-blue-700' : plan.id === 'starter' ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-white border border-blue-600 text-blue-600 hover:bg-blue-50'}`}
                    >
                      {plan.buttonText}
                    </Link>
                  </div>
                  <div className="border-t mt-auto">
                    <div className="p-6">
                      <h4 className="font-medium text-gray-900 mb-3 flex items-center justify-between">
                        ...
                        <button
                          onClick={() => togglePlan(plan.id)} className="text-blue-600 text-sm flex items-center"
                        >
                      ...
                      {/* Expanded plan details */} {expandedPlan === plan.id && plan.featureCategories && (
                                ...
                                <ul className="space-y-2 ml-7">
                                  {category.features.map(
                                    (feature, featureIndex) => (
                                      <li
                                        key={featureIndex} className="flex items-start"
                                      >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        id="company"
                        name="company"
                        value={contactForm.company} onChange={handleContactChange}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md"
                        required
                      />
                    </div>

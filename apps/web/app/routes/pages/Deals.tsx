  ...
  return <div className="bg-gray-50 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
                ...
                <div className="hidden md:block relative">
                  <button onClick={() => setShowMobileSort(!showMobileSort)} className="px-4 py-2 border border-gray-300 rounded-md text-gray-700 font-medium flex items-center hover:bg-gray-50">
                    ...
                    <span className="font-medium ml-1">
                      {filterOptions.sortBy === 'relevance' && 'Relevance'} {filterOptions.sortBy === 'expiringSoon' && 'Expiring Soon'} {filterOptions.sortBy === 'newest' && 'Newest'} {filterOptions.sortBy === 'popular' && 'Most Popular'} {filterOptions.sortBy === 'distance' && 'Distance'}
                    </span>
            ...
            {/* Active Filters */} {(filterOptions.categories.length > 0 || filterOptions.discountTypes.length > 0 || filterOptions.onlyExclusive) && <div className="mt-4 flex flex-wrap items-center gap-2">
                ...
                {filterOptions.categories.map(category => <span key={category} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                  ...
                  </span>)} {filterOptions.discountTypes.map(type => <span key={type} className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                    {type === 'percentage' && 'Percentage Off'} {type === 'fixed' && 'Fixed Amount Off'} {type === 'bogo' && 'Buy One Get One'} {type === 'free' && 'Free Items'}
                    <button onClick={() => toggleDiscountTypeFilter(type)} className="ml-1 text-purple-600 hover:text-purple-800">
                      <XIcon className="w-3 h-3" />
                    </button>
                  </span>)} {filterOptions.onlyExclusive && <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-800">
                    Exclusive Deals
          ...
          <div className="flex flex-col md:flex-row">
                ...
                <div className="p-4 border-b">
                  ...
                  <div>
                    ...
                    <div className="flex justify-between mt-2 text-sm text-gray-600">
                      <span>1 mile</span>
                      <span>
                        {filterOptions.maxDistance} {' '} {filterOptions.maxDistance === 1 ? 'mile' : 'miles'}
                      </span>
                      <span>10 miles</span>
                    </div>
                  </div>
            ...
            <div className="flex-grow">
              {viewMode === 'map' ? <div className="bg-white rounded-lg shadow-sm overflow-hidden h-[calc(100vh-240px)] min-h-[500px]">
                    ...
                    <div className="absolute top-4 right-4 w-80 max-h-[calc(100%-32px)] overflow-y-auto bg-white rounded-lg shadow-lg">
                      ...
                      <div className="divide-y divide-gray-100">
                        {filteredDeals.slice(0, 5).map(deal => <div key={deal.id} className="p-3 hover:bg-gray-50 cursor-pointer">
                          ...
                          </div>)} {filteredDeals.length > 5 && <div className="p-3 text-center">
                  ...
                  {/* Featured Deals */} {filteredDeals.some(deal => deal.isFeatured) && <div className="mb-8">

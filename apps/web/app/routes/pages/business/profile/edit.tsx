  ...
  const formSections: FormSection[] = [{
    ...
    component: <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              {/* Current Holiday Hours */} {formState.hours.holidayHours && Object.keys(formState.hours.holidayHours).length > 0 && <div className="border rounded-md p-4">
    ...
    component: <div className="space-y-8">
          ...
          <div>
            ...
            {/* Current Menu Items */} {formState.menu && formState.menu.length > 0 ? <div className="space-y-4 mb-6">
          ...
          <div>
            ...
            {/* Current Services */} {formState.services && formState.services.length > 0 ? <div className="space-y-4 mb-6">

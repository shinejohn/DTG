...
import { SocialShareModal } from '@/components/dtg/SocialShareModal';
...
export default function DealDetail() {
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              {activeTab === 'details' && <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    {showFullDescription ? deal.description : `${deal.description.substring(0, 150)}${deal.description.length > 150 ? '...' : ''}`} {deal.description.length > 150 && <button onClick={() => setShowFullDescription(!showFullDescription)} className="ml-1 text-blue-600 hover:text-blue-800 font-medium">
            ...
            {/* Sidebar */}
            <div>
              {/* Related deals */} {deal.relatedDeals && deal.relatedDeals.length > 0 && <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
      ...
      <Footer />
      {deal && <SocialShareModal isOpen={isShareModalOpen} onClose={() => setIsShareModalOpen(false)} title={deal.title} description={deal.description} imageUrl={deal.business.image} url={window.location.href} />} {/* Login Modal */} {showLoginModal && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">

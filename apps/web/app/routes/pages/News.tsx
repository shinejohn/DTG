...
const allNewsItems = [{
  ...
  date: 'Today',
  image: 'https://images.unsplash.com/photo-1577720580479-7d839d829c59?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
  ...
  date: 'Yesterday',
  image: 'https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-6">
            <p className="text-gray-600">
              ...
              news articles
              {selectedCategory !== 'All' ? ` in ${selectedCategory}` : ''} {searchQuery ? ` matching "${searchQuery}"` : ''}
            </p>
          </div>
          {/* News Grid */}
          ...
          {/* Empty State */} {newsItems.length === 0 && <div className="text-center py-12">
              <div className="mb-4">

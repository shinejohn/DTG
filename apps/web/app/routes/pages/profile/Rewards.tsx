  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg shadow-sm p-4 text-white">
            ...
            <p className="text-purple-100 text-sm">
              Across{' '} {new Set(mockUserRewards.achievements.map(a => a.businessId)).size} {' '}
              businesses
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm mb-6 overflow-hidden">
          ...
          {/* Loyalty Programs Tab */} {activeTab === 'programs' && <div className="p-6">
                ...
                {mockUserRewards.loyaltyPrograms.map(program => <div key={program.id} className="border rounded-lg overflow-hidden">
                    <div className="p-4">
                      ...
                      <div className="mt-4">
                        ...
                        backgroundColor: program.currentTier === 'Bronze' ? '#CD7F32' : program.currentTier === 'Silver' ? '#C0C0C0' : '#FFD700'
                          ...
                          <div className="text-sm text-gray-600">
                            {program.points} /{' '} {program.points + program.pointsToNextTier} points
                          </div>
                        </div>
                      ...
                      <div className="mt-4 flex justify-between">
                        <div className="text-sm text-gray-600">
                          <span className="font-medium">Last activity:</span>{' '} {formatDate(program.lastActivity)}
                        </div>
            ...
            </div>} {/* Coupons Tab */} {activeTab === 'coupons' && <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                  ...
                  {mockUserRewards.coupons.filter(coupon => !coupon.isUsed).map(coupon => <div key={coupon.id} className="border rounded-lg overflow-hidden">
                        <div className="p-4">
                          ...
                          <div className="flex justify-between items-center">
                            <div className="text-sm text-gray-600">
                              <span className="font-medium">Expires:</span>{' '} {formatDate(coupon.expiryDate)}
                              <br />
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex justify-between items-center">
                            <div className="text-sm text-gray-500">
                              <span className="font-medium">Expired:</span>{' '} {formatDate(coupon.expiryDate)}
                            </div>
            ...
            </div>} {/* Achievements Tab */} {activeTab === 'achievements' && <div className="p-6">
              <div className="flex justify-between items-center mb-4">
            ...
            </div>} {/* Points History Tab */} {activeTab === 'history' && <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <h3 className="font-medium text-gray-900">
                              {entry.type === 'earned' ? 'Earned' : 'Redeemed'}:{' '} {entry.reason}
                            </h3>
      ...
      {/* Coupon Modal */} {showCouponModal && selectedCoupon && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            <div className="p-6">
              ...
              <div className="text-center mb-4">
                ...
                <div className="text-sm text-gray-600 mb-4">
                  <div className="mb-1">
                    <span className="font-medium">Expires:</span>{' '} {formatDate(selectedCoupon.expiryDate)}
                  </div>
                  <div className="mb-1">
                    <span className="font-medium">Saved on:</span>{' '} {formatDate(selectedCoupon.savedDate)}
                  </div>
                </div>
                {/* Usage Status */} {selectedCoupon.isUsed && <div className="bg-gray-100 border border-gray-200 rounded-lg p-3 mb-4">

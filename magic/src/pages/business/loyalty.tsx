...
const mockLoyaltyProgram: LoyaltyProgram = {
  id: 'lp1',
  name: 'Urban Bites Rewards',
  description: 'Earn points with every purchase and redeem for exclusive rewards and discounts.',
  status: 'active',
  pointsSettings: {
    pointsPerDollar: 10,
    minimumPointsRedemption: 100,
    pointsValueInCents: 5,
  ...
  tiers: [{
    ...
    name: 'Bronze',
    threshold: 0,
    benefits: ['Earn 10 points per $1 spent', 'Birthday reward', 'Access to standard rewards'],
    color: '#CD7F32',
    icon: 'star',
    multiplier: 1
  }, {
    ...
    name: 'Silver',
    threshold: 500,
    benefits: ['Earn 12 points per $1 spent', 'Birthday reward', 'Free drink on every 5th visit', 'Early access to seasonal items'],
    color: '#C0C0C0',
    icon: 'award',
    multiplier: 1.2
  }, {
    ...
    name: 'Gold',
    threshold: 1500,
    benefits: ['Earn 15 points per $1 spent', 'Birthday reward', 'Free drink on every 5th visit', 'Early access to seasonal items', 'Priority service', 'Exclusive gold member events'],
    color: '#FFD700',
    icon: 'crown',
    multiplier: 1.5
  }],
  rewards: [{
    ...
    restrictions: ['Valid for 30 days after redemption'],
    availability: 'always',
    quantityRedeemed: 87,
    isActive: true,
    ...
    restrictions: ['Maximum discount of $20', 'Cannot be combined with other offers'],
    availability: 'always',
    quantityRedeemed: 42,
    isActive: true,
    ...
    id: 'r3',
    name: 'Free Dessert',
    description: 'Redeem for a free dessert of your choice',
    pointsCost: 200,
    type: 'free_item',
    value: 'Any dessert',
    ...
    type: 'gift_card',
    value: 10,
    image: 'https://images.unsplash.com/photo-1556742393-d75f468bfcb0?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    availability: 'always',
    quantityRedeemed: 29,
    isActive: true,
    ...
    description: 'Learn to make specialty coffee with our head barista (30 min session)',
    pointsCost: 1000,
    type: 'experience',
    value: 'Coffee class',
    image: 'https://images.unsplash.com/photo-1516600164266-f3b8166ae679?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    restrictions: ['Reservation required', 'Subject to availability'],
    availability: 'limited',
    quantityAvailable: 10,
    quantityRedeemed: 4,
    tierRestriction: ['Silver', 'Gold'],
    isActive: true,
    createdAt: '2023-01-15T10:50:00Z'
  }, {
    id: 'r6',
    name: 'Buy One Get One Free',
    description: 'Buy any sandwich and get one free',
    pointsCost: 400,
    type: 'discount',
    value: 'BOGO',
    image: 'https://images.unsplash.com/photo-1481070414801-51fd732d7184?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    restrictions: ['Valid for 14 days after redemption', 'Equal or lesser value item free'],
    availability: 'always',
    quantityRedeemed: 38,
    isActive: true,
  ...
  lastModified: '2023-07-10T14:30:00Z',
  stats: {
    totalMembers: 458,
    activeMembers: 312,
    totalPointsIssued: 287500,
    totalPointsRedeemed: 145300,
    averagePointsPerMember: 310,
    redemptionRate: 0.51
  }
};
const mockLoyaltyMembers: LoyaltyMember[] = [{
  ...
  lifetimePoints: 1250,
  tier: 'Silver',
  joinDate: '2023-02-10T15:30:00Z',
  lastActive: '2023-07-15T12:45:00Z',
  totalSpent: 325.75,
  visitsCount: 23,
  birthdayMonth: 4,
  birthdayDay: 15,
  ...
  pointsHistory: [{
    ...
    amount: 120,
    type: 'earn',
    description: 'Purchase of $12.00',
    date: '2023-07-15T12:45:00Z'
  }, {
    id: 'ph2',
    amount: 150,
    type: 'redeem',
  ...
  lifetimePoints: 3200,
  tier: 'Gold',
  joinDate: '2023-01-05T09:15:00Z',
  lastActive: '2023-07-18T08:30:00Z',
  totalSpent: 875.5,
  visitsCount: 47,
  birthdayMonth: 9,
  birthdayDay: 22,
  rewardHistory: [{
    id: 'rh3',
    rewardId: 'r5',
    rewardName: 'Barista Experience',
    pointsSpent: 1000,
    date: '2023-06-12T16:00:00Z'
  }, {
    id: 'rh4',
    rewardId: 'r2',
    rewardName: '15% Off Your Order',
    pointsSpent: 300,
    date: '2023-04-30T13:20:00Z'
  }],
  pointsHistory: [{
    id: 'ph5',
    amount: 150,
    type: 'earn',
    description: 'Purchase of $10.00',
    date: '2023-07-18T08:30:00Z'
  }, {
    id: 'ph6',
    amount: 1000,
    type: 'redeem',
    description: 'Redeemed for Barista Experience',
    date: '2023-06-12T16:00:00Z'
  }]
}, {
  id: 'm3',
  ...
  lifetimePoints: 325,
  tier: 'Bronze',
  joinDate: '2023-05-20T11:45:00Z',
  lastActive: '2023-07-10T15:30:00Z',
  totalSpent: 95.25,
  visitsCount: 8,
  rewardHistory: [],
  pointsHistory: [{
  ...
  lifetimePoints: 1480,
  tier: 'Silver',
  joinDate: '2023-03-15T13:20:00Z',
  lastActive: '2023-07-17T17:10:00Z',
  totalSpent: 410.3,
  visitsCount: 32,
  birthdayMonth: 11,
  birthdayDay: 3,
  ...
  pointsHistory: [{
    ...
    type: 'earn',
    description: 'Purchase of $7.50',
    date: '2023-07-17T17:10:00Z'
  }, {
    id: 'ph10',
    amount: 400,
    type: 'redeem',
    description: 'Redeemed for Buy One Get One Free',
    date: '2023-06-05T12:30:00Z'
  }]
}, {
  id: 'm5',
  ...
  lifetimePoints: 350,
  tier: 'Bronze',
  joinDate: '2023-04-10T10:00:00Z',
  lastActive: '2023-05-25T14:15:00Z',
  totalSpent: 120.75,
  visitsCount: 12,
  rewardHistory: [{
    id: 'rh6',
...
const mockPointsActivity: PointsActivity[] = [{
  id: 'pa1',
  memberId: 'm1',
  ...
  amount: 50,
  type: 'adjust',
  description: 'Manual adjustment - Service recovery',
...
export function BusinessLoyalty() {
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
          ...
          {activeTab === 'overview' && <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  {/* Upcoming Birthdays */}
                  {upcomingBirthdays.length > 0 && <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      ...
      {/* Member Detail Modal */}
      {showMemberModal && selectedMember && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      {/* Adjust Points Modal */}
      {showAdjustPointsModal && selectedMember && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      {/* Reward Detail Modal */}
      {showRewardModal && selectedReward && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">

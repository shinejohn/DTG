...
const mockEvents: Event[] = [{
  ...
  description: 'Join us for a delightful afternoon exploring the nuances of summer coffee blends. Our head barista will guide you through tasting notes and brewing techniques.',
  date: '2023-07-22T15:00:00Z',
  endDate: '2023-07-22T17:00:00Z',
  location: 'Urban Bites Café, 123 Main St',
  imageUrl: 'https://images.unsplash.com/photo-1511537190424-bbbab87ac5eb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8Y29mZmVlJTIwdGFzdGluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  status: 'upcoming',
  eventType: 'business',
  capacity: 30,
  attendees: 24,
  ...
  syncedWith: ['WhensTheFun', 'SocialConnect']
}, {
  id: 'e2',
  title: 'Downtown Food Festival',
  description: 'The annual Downtown Food Festival brings together the best local restaurants and food vendors. Come hungry and experience a diverse range of culinary delights!',
  date: '2023-08-05T12:00:00Z',
  endDate: '2023-08-05T20:00:00Z',
  location: 'Central Plaza',
  imageUrl: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Zm9vZCUyMGZlc3RpdmFsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  status: 'upcoming',
  eventType: 'sponsored',
  attendees: 1500,
  isFree: true,
  ...
  syncedWith: ['WhensTheFun']
}, {
  id: 'e3',
  title: 'Local Artisan Market',
  description: 'Browse handcrafted goods from local artisans while enjoying specialty coffee and pastries from Urban Bites Café.',
  date: '2023-07-16T10:00:00Z',
  endDate: '2023-07-16T16:00:00Z',
  location: 'Riverside Park',
  imageUrl: 'https://images.unsplash.com/photo-1534531173927-aeb928d54385?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YXJ0aXNhbiUyMG1hcmtldHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  status: 'upcoming',
  eventType: 'community',
  attendees: 750,
  isFree: true,
  ...
  tags: ['market', 'artisan', 'local'],
  syncedWith: ['WhensTheFun']
}, {
  id: 'e4',
  title: 'Barista Championship',
  description: 'Our head barista competed in the regional Barista Championship, showcasing our signature espresso blend and latte art techniques.',
  date: '2023-06-10T09:00:00Z',
  endDate: '2023-06-10T17:00:00Z',
  location: 'Convention Center',
  imageUrl: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YmFyaXN0YXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  status: 'past',
  eventType: 'sponsored',
  attendees: 300,
  isFree: false,
  ticketPrice: 15,
  visibility: 'public',
  organizer: 'Coffee Association',
  tags: ['competition', 'barista', 'coffee'],
  syncedWith: ['WhensTheFun', 'SocialConnect']
}, {
  id: 'e5',
  title: 'Customer Appreciation Day',
  description: 'Join us for a day of special discounts, free samples, and live music as we celebrate our amazing customers!',
  date: '2023-08-15T11:00:00Z',
  endDate: '2023-08-15T19:00:00Z',
  location: 'Urban Bites Café, 123 Main St',
  imageUrl: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cmVzdGF1cmFudCUyMGV2ZW50fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  status: 'draft',
  eventType: 'business',
  capacity: 100,
  isFree: true,
  visibility: 'public',
  organizer: 'Urban Bites Café',
  tags: ['appreciation', 'music', 'special']
}, {
  id: 'e6',
  title: 'Breakfast Menu Tasting',
  description: 'Private event for food bloggers and critics to preview our new breakfast menu items.',
  date: '2023-07-28T08:00:00Z',
  endDate: '2023-07-28T10:00:00Z',
  location: 'Urban Bites Café, 123 Main St',
  imageUrl: 'https://images.unsplash.com/photo-1533089860892-a9b969df67e3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8YnJlYWtmYXN0JTIwcmVzdGF1cmFudHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  status: 'upcoming',
  eventType: 'business',
  capacity: 15,
  attendees: 12,
  ...
  visibility: 'private',
  organizer: 'Urban Bites Café',
  tags: ['breakfast', 'tasting', 'preview']
}];
const mockSponsors: Sponsor[] = [{
  ...
  contribution: 1000,
  benefits: ['Logo on event banner', 'Booth at prime location', 'Social media mentions', 'Inclusion in event program'],
  status: 'confirmed'
}, {
  id: 's2',
  name: 'Urban Bites Café',
  ...
  contribution: 500,
  benefits: ['Logo on event website', 'Social media mentions', 'Inclusion in event program'],
  status: 'confirmed'
}];
const mockSponsorshipOpportunities: SponsorshipOpportunity[] = [{
  id: 'so1',
  eventName: 'Summer Music Festival',
  eventId: 'se1',
  organizerName: 'City Arts Council',
  date: '2023-08-20T16:00:00Z',
  location: 'Riverside Park',
  imageUrl: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8ZmVzdGl2YWx8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60',
  sponsorshipLevels: [{
    name: 'Platinum',
    price: 2500,
    benefits: ['Main stage naming rights', 'Prime logo placement on all materials', 'VIP passes for 10 guests', 'Dedicated social media campaign'],
    available: 1
  }, {
    name: 'Gold',
    price: 1000,
    benefits: ['Secondary stage naming rights', 'Logo on all printed materials', 'VIP passes for 5 guests', 'Social media mentions'],
    available: 3
  }, {
    name: 'Silver',
    price: 500,
    benefits: ['Logo on event website', 'Logo on event program', 'VIP passes for 2 guests'],
    available: 5
  }],
  attendeeCount: 3000,
  description: 'Annual summer music festival featuring local and regional bands across multiple genres. The event attracts a diverse audience and receives significant media coverage.',
  applicationDeadline: '2023-07-25T23:59:59Z',
  status: 'open'
}, {
  id: 'so2',
  eventName: 'Farmers Market Season Opener',
  eventId: 'se2',
  organizerName: 'Downtown Business Association',
  date: '2023-08-01T09:00:00Z',
  location: 'Central Plaza',
  imageUrl: 'https://images.unsplash.com/photo-1488459716781-31db52582fe9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8ZmFybWVycyUyMG1hcmtldHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  sponsorshipLevels: [{
    name: 'Gold',
    price: 750,
    benefits: ['Logo on market banners', 'Booth at prime location', 'Mention in radio advertisements', 'Social media features'],
    available: 2
  }, {
    name: 'Silver',
    price: 350,
    benefits: ['Logo on market website', 'Booth at standard location', 'Social media mentions'],
    available: 4
  }, {
    name: 'Bronze',
    price: 150,
    benefits: ['Logo on market website', 'Mention in market newsletter'],
    available: 6
  }],
  attendeeCount: 1500,
  description: 'Season opening of the weekly farmers market featuring local produce, crafts, and food vendors. This special opening event includes live music and cooking demonstrations.',
  ...
  date: '2023-07-28T07:30:00Z',
  location: 'Grand Hotel Conference Center',
  imageUrl: 'https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YnVzaW5lc3MlMjBuZXR3b3JraW5nfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  sponsorshipLevels: [{
    name: 'Gold',
    price: 500,
    benefits: ['Speaking opportunity (5 minutes)', 'Logo on all materials', '4 complimentary tickets', 'Distribution of promotional materials'],
    available: 1
  }, {
    name: 'Silver',
    price: 250,
    benefits: ['Logo on all materials', '2 complimentary tickets', 'Distribution of promotional materials'],
    available: 3
  }],
  attendeeCount: 75,
  description: 'Monthly business networking breakfast featuring a guest speaker discussing local economic development. Attended by business owners and professionals from various industries.',
  applicationDeadline: '2023-07-20T23:59:59Z',
  status: 'open'
}];
const mockEventMetrics: Record<string, EventMetrics> = {
  e1: {
    viewCount: 432,
...
export function BusinessEvents() {
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-grow flex">
        ...
        <main className="flex-grow p-4 md:p-6">
          ...
          <div className="bg-white rounded-lg shadow-sm mb-6">
            ...
            {/* Calendar View Tab */}
            {activeTab === 'calendar' && <div className="p-4">
                {/* Calendar Header */}
                ...
                <div className="border rounded-lg overflow-hidden">
                  ...
                  return <div key={index} className={`min-h-32 p-1 ${isCurrentMonth ? 'bg-white' : 'bg-gray-50'} 
                        ...
                        handleViewEvent(event);
                          ...
                          {hasEvents && day.events.length > 3 && <div className="absolute bottom-1 right-1 text-xs text-gray-500">
            ...
            {/* Sponsorships Tab */}
            {activeTab === 'sponsorships' && <div className="p-4">
                <div className="mb-6">
                        ...
                        <div className="p-4">
                          ...
                          <div className="text-sm text-gray-600 mb-3">
                            <div className="flex items-center">
                              ...
                              Apply by:{' '}
                              {formatDate(opportunity.applicationDeadline, false)}
                            </div>
                          </div>
            ...
            {/* Analytics Tab */}
            {activeTab === 'analytics' && <div className="p-4">
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-4">
                    Event Performance
                  </h3>
      ...
      <Footer />
      {/* Event View Modal */}
      {selectedEvent && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="col-span-2">
                  ...
                  <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          {selectedEvent.attendees !== undefined ? <>
                              ...
                              {selectedEvent.capacity ? `of ${selectedEvent.capacity}` : ''}{' '}
                              registered
                    ...
                    {selectedEvent.tags && selectedEvent.tags.length > 0 && <div className="flex items-start">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedEvent.status === 'draft' && <button className="w-full px-4 py-2 border border-green-600 text-green-600 font-medium rounded-md hover:bg-green-50 flex items-center justify-center">
                        <CheckIcon className="w-4 h-4 mr-1" />
                        Publish Event
                      </button>}
                    {selectedEvent.status === 'upcoming' && !selectedEvent.syncedWith?.includes('WhensTheFun') && <button onClick={toggleWhensTheFunSyncModal} className="w-full px-4 py-2 border border-purple-600 text-purple-600 font-medium rounded-md hover:bg-purple-50 flex items-center justify-center">
              ...
              {mockEventMetrics[selectedEvent.id] && <div className="border-t pt-6 mt-6">
      ...
      {/* Create Event Modal */}
      {isCreatingEvent && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
      ...
      {/* WhensTheFun Sync Modal */}
      {showWhensTheFunSyncModal && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      {isApplyingSponsorshipForm && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-600">
                          Organized by:{' '}
                          {sponsorshipOpportunities.find(o => o.id === isApplyingSponsorshipForm)?.organizerName}
                        </p>
                        <p className="text-sm text-gray-600">
      ...
      {/* Day Selection Modal */}
      {selectedDate && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">

...
const mockPromotions: Promotion[] = [{
  ...
  description: 'Buy one coffee, get one free between 3PM - 5PM',
  type: 'bogo',
  code: 'HAPPYHOUR',
  ...
  description: 'Get 15% off any lunch item Monday through Friday',
  type: 'discount',
  ...
  viewCount: 645,
  saveCount: 72,
  imageUrl: 'https://images.unsplash.com/photo-1525610553991-2bede1a236e2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YnJlYWtmYXN0fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60'
}, {
  id: 'p3',
  title: 'First-Time Customer',
  description: 'First-time visitors get a free pastry with any drink purchase',
  type: 'freebie',
  code: 'WELCOME',
  ...
  description: 'Get a free mimosa with any brunch entrée on weekends',
  type: 'freebie',
  code: 'BRUNCH',
  ...
  isActive: true,
  isRecurring: true,
  recurrencePattern: 'Weekends only',
  targetAudience: 'All customers',
  redemptionLimit: 0,
  redemptionCount: 65,
  viewCount: 420,
  saveCount: 48,
  imageUrl: 'https://images.unsplash.com/photo-1533920379810-6bedac961c2a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bWltb3NhfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60'
}, {
  id: 'p5',
  title: 'Summer Special',
  description: '$5 off any purchase of $25 or more',
  type: 'discount',
  discountType: 'fixed',
  discountValue: 5,
  code: 'SUMMER5',
  ...
  viewCount: 1850,
  saveCount: 245,
  imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8ZHJpbmtzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60'
}, {
  id: 'p6',
  title: 'Holiday Gift Card Special',
  description: 'Buy a $50 gift card, get a $10 bonus card',
  type: 'special',
  ...
  viewCount: 0,
  saveCount: 0,
  imageUrl: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Z2lmdCUyMGNhcmR8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60'
}];
      ...
      <div className="flex-grow flex">
        ...
        <main className="flex-grow p-4 md:p-6">
          ...
          {view === 'list' && <>
              ...
              {/* Promotions List */}
              {filteredPromotions.length === 0 ? <div className="bg-white rounded-lg shadow-sm p-8 text-center">
                  ...
                  {filteredPromotions.map(promotion => <div key={promotion.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
                      <div className="md:flex">
                        {/* Promotion Image */}
                        {promotion.imageUrl && <div className="md:w-1/4 h-48 md:h-auto">
                          ...
                          <div className="flex flex-wrap items-start justify-between mb-2">
                            <div>
                              <div className="flex items-center">
                                ...
                                {promotion.isActive && promotion.isPaused && <span className="ml-2 px-2 py-0.5 bg-yellow-100 text-yellow-800 text-xs font-medium rounded-full">
                                    Paused
                                  </span>}
                                {!promotion.isActive && <span className="ml-2 px-2 py-0.5 bg-red-100 text-red-800 text-xs font-medium rounded-full">
                                    Inactive
                                  </span>}
                                {promotion.isRecurring && <span className="ml-2 px-2 py-0.5 bg-purple-100 text-purple-800 text-xs font-medium rounded-full">
                                    Recurring
                                  </span>}
                              </div>
          ...
          {(view === 'create' || view === 'edit') && <>
              ...
              {/* Promotion Templates */}
              {view === 'create' && !showTemplates && <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
              ...
              {/* Template Selection */}
              {showTemplates && <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
                  <div className="flex items-center justify-between mb-4">

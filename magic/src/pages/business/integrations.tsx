...
const mockPlatforms: Platform[] = [{
  id: 'day-news',
  name: 'Day.News',
  icon: <NewspaperIcon className="w-5 h-5 text-blue-600" />,
  connected: true,
  ...
  id: 'social-connect',
  name: 'SocialConnect',
  icon: <ShareIcon className="w-5 h-5 text-green-600" />,
  connected: true,
  lastSync: '2023-07-14T18:20:00Z',
  status: 'active',
  stats: {
    mentions: 28,
    notifications: 8
  ...
  id: 'local-directory',
  name: 'LocalDirectory',
  icon: <MapPinIcon className="w-5 h-5 text-red-600" />,
  connected: true,
  lastSync: '2023-07-13T09:15:00Z',
  status: 'active'
}, {
  id: 'review-hub',
  name: 'ReviewHub',
  icon: <MessageSquareIcon className="w-5 h-5 text-yellow-600" />,
  connected: false,
  status: 'disconnected'
}, {
  id: 'email-marketing',
  name: 'EmailMarketing',
  icon: <MailIcon className="w-5 h-5 text-indigo-600" />,
  connected: false,
  status: 'disconnected'
}];
const mockNewsItems: NewsItem[] = [{
  ...
  image: 'https://images.unsplash.com/photo-1525610553991-2bede1a236e2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YnJlYWtmYXN0fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  url: '/news/best-breakfast-spots',
  type: 'mention',
  sentiment: 'positive'
}, {
  id: 'n2',
  title: 'Downtown Restaurant Week announced - Will Urban Bites participate?',
  source: 'Day.News',
  ...
  url: '/news/downtown-restaurant-week',
  type: 'news',
  sentiment: 'neutral'
}, {
  id: 'n3',
  title: 'Urban Bites Café launches new summer menu - Local foodies approve',
  source: 'SocialConnect',
  date: '2023-07-10T09:45:00Z',
  image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8Y29mZmVlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  url: '/social/urban-bites-summer-menu',
  type: 'mention',
  sentiment: 'positive'
}, {
  id: 'n4',
  title: 'City Council approves outdoor dining expansion for downtown cafés',
  source: 'Day.News',
  date: '2023-07-08T16:20:00Z',
  image: 'https://images.unsplash.com/photo-1533777857889-4be7c70b33f7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fG91dGRvb3IlMjBjYWZlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  url: '/news/outdoor-dining-expansion',
  type: 'news',
  sentiment: 'positive'
}];
const mockEventItems: EventItem[] = [{
  ...
  image: 'https://images.unsplash.com/photo-1511537190424-bbbab87ac5eb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8Y29mZmVlJTIwdGFzdGluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  url: '/events/summer-coffee-tasting',
  status: 'upcoming',
  attendees: 24
}, {
  id: 'e2',
  ...
  image: 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8Zm9vZCUyMGZlc3RpdmFsfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  url: '/events/downtown-food-festival',
  status: 'upcoming',
  attendees: 1500,
  sponsored: true
}, {
  ...
  image: 'https://images.unsplash.com/photo-1534531173927-aeb928d54385?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YXJ0aXNhbiUyMG1hcmtldHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  url: '/events/local-artisan-market',
  status: 'upcoming',
  attendees: 750
}, {
  id: 'e4',
  ...
  image: 'https://images.unsplash.com/photo-1442512595331-e89e73853f31?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YmFyaXN0YXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  url: '/events/barista-championship',
  status: 'past',
  attendees: 300,
  sponsored: true
}];
const mockNotifications: Notification[] = [{
  id: 'notif1',
  title: 'New business mention',
  message: 'Urban Bites Café was mentioned in "Best Breakfast Spots" article',
  date: '2023-07-14T10:30:00Z',
  platform: 'Day.News',
  read: false,
  type: 'mention',
  icon: <NewspaperIcon className="w-4 h-4 text-blue-600" />
}, {
  id: 'notif2',
  title: 'Event reminder',
  message: 'Your "Summer Coffee Tasting Workshop" event is in 3 days',
  date: '2023-07-19T09:00:00Z',
  platform: 'WhensTheFun',
  read: false,
  type: 'event',
  ...
  id: 'notif3',
  title: 'New review',
  message: 'You received a 5-star review from Sarah J.',
  date: '2023-07-13T15:45:00Z',
  platform: 'ReviewHub',
  read: true,
  type: 'review',
  icon: <MessageSquareIcon className="w-4 h-4 text-yellow-600" />
}, {
  id: 'notif4',
  title: 'Social mention',
  message: '@foodcritic mentioned you in a post: "Loving the new summer menu at @UrbanBitesCafe"',
  date: '2023-07-10T09:45:00Z',
  platform: 'SocialConnect',
  read: true,
  type: 'mention',
  icon: <ShareIcon className="w-4 h-4 text-green-600" />
}, {
  id: 'notif5',
  title: 'Integration alert',
  message: 'LocalDirectory integration needs to be refreshed',
  date: '2023-07-09T11:20:00Z',
  platform: 'LocalDirectory',
  read: true,
  type: 'alert',
...
const mockContentItems: ContentItem[] = [{
  ...
  platforms: ['SocialConnect', 'Day.News'],
  status: 'published',
  engagement: {
    views: 1240,
    likes: 87,
  ...
  type: 'event',
  date: '2023-07-22T15:00:00Z',
  platforms: ['WhensTheFun', 'SocialConnect'],
  status: 'published',
  engagement: {
    views: 520,
    likes: 45,
  ...
  platforms: ['SocialConnect', 'LocalDirectory'],
  status: 'published',
  engagement: {
    views: 890,
    likes: 62,
  ...
  platforms: ['WhensTheFun', 'SocialConnect', 'Day.News'],
  status: 'draft'
}];
...
export function BusinessIntegrations() {
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
          ...
          <div className="bg-white rounded-lg shadow-sm p-4 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
              {platforms.map(platform => <div key={platform.id} className="border rounded-lg p-4 relative">
                  ...
                  {platform.connected && platform.stats && <div className="flex flex-wrap gap-2 mb-3">
                      ...
                      {platform.stats.events && <div className="text-xs bg-purple-50 text-purple-700 px-2 py-1 rounded-full">
                          {platform.stats.events} events
                        </div>}
                      {platform.stats.notifications && <div className="text-xs bg-yellow-50 text-yellow-700 px-2 py-1 rounded-full">
                          ...
                          <div className="p-4">
                            <div className="flex items-center justify-between mb-2">
                              <div className="flex items-center">
                                ...
                                {item.sentiment && <span className={`text-xs font-medium px-2.5 py-0.5 rounded-full
                            ...
                            <div className="flex items-center">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-gray-600">
                                  {platform.connected ? <>
                                      Connected{' '}
                                      {platform.lastSync && `· Last synced: ${formatDate(platform.lastSync)}`}
                                    </> : 'Not connected'}
                                </p>
                              </div>
                            </div>
      ...
      {isConnectingPlatform && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      ...
      {isCreatingContent && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">

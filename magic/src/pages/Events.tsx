  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {/* Calendar View */}
          {viewMode === 'calendar' && <EventsCalendar events={eventItems} onFilterChange={handleFilterChange} />}
          {/* List View */}
          {viewMode === 'list' && <>
              {/* Filters and Search */}
              ...
              <div className="mb-6">
                <p className="text-gray-600">
                  ...
                  {priceFilter !== 'all' ? ` (${priceFilter === 'free' ? 'Free' : 'Paid'} events)` : ''}
              ...
              {/* Empty State */}
              {eventItems.length === 0 && <div className="text-center py-12">
                  <div className="mb-4">

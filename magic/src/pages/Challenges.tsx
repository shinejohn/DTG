...
// Active Challenges
{
  ...
  description: 'Visit and review 10 different restaurants this summer',
  category: 'seasonal',
  type: 'check-in',
  ...
  rewards: {
    points: 500,
    badge: 'https://images.unsplash.com/photo-1533928298208-27ff66555d8d?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80',
    coupon: {
      id: 'coupon1',
  ...
  milestones: [{
    ...
    count: 10,
    reward: 'Summer Foodie Badge + 500 points',
    completed: false
  }],
  friendsParticipating: [{
    id: 'f1',
  ...
  description: 'Check in at 15 different downtown businesses',
  category: 'local',
  type: 'exploration',
  ...
  rewards: {
    points: 300,
    badge: 'https://images.unsplash.com/photo-1490598000245-075175152d25?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
  },
  joinedAt: '2023-07-05T14:45:00Z',
  milestones: [{
    count: 5,
    reward: '50 points',
    completed: true
    ...
    count: 15,
    reward: 'Downtown Explorer Badge + 300 points',
    completed: false
  }]
}, {
  id: 'c3',
  title: 'Photo Contest: Best Local Dish',
  description: 'Upload photos of your favorite local dishes',
  category: 'community',
  type: 'photo',
  ...
  rewards: {
    ...
    coupon: {
      ...
      description: 'Free dessert with any purchase'
    }
  },
  joinedAt: '2023-08-02T09:15:00Z'
},
// Available Challenges
{
  id: 'c4',
  title: 'Coffee Shop Crawl',
  description: 'Visit 8 different coffee shops and leave a review',
  category: 'business',
  type: 'review',
  ...
  rewards: {
    points: 400,
    badge: 'https://images.unsplash.com/photo-1518057111178-44a106bad636?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
  }
}, {
  id: 'c5',
  title: 'Local Business Supporter',
  description: 'Leave 10 helpful reviews for small businesses',
  category: 'community',
  type: 'review',
  startDate: '2023-08-01T00:00:00Z',
  ...
  rewards: {
    points: 350,
    badge: 'https://images.unsplash.com/photo-1577415124269-fc1140a69e91?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
  }
}, {
  id: 'c6',
  title: 'Urban Bites Café Challenge',
  description: 'Try 5 different menu items and share photos',
  category: 'business',
  type: 'photo',
  ...
  rewards: {
    ...
    coupon: {
      id: 'coupon3',
      businessName: 'Urban Bites Café',
      description: 'Free specialty coffee'
    }
  },
  business: {
    id: 'b1',
    name: 'Urban Bites Café',
    logo: 'https://images.unsplash.com/photo-1544148103-0773bf10d330?ixlib=rb-1.2.1&auto=format&fit=crop&w=100&q=60'
  }
},
// Past Challenges
{
  ...
  description: 'Check in at the Spring Food Festival and share your experience',
  category: 'seasonal',
  type: 'social',
  ...
  rewards: {
    points: 150,
    badge: 'https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80'
  },
  joinedAt: '2023-04-16T11:30:00Z',
  completedAt: '2023-04-16T16:45:00Z'
}, {
  id: 'c8',
  title: 'New Restaurant Reviewer',
  description: 'Be among the first to review 3 newly opened restaurants',
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-8">
          ...
          {/* Active Challenges Summary - Only show if there are active challenges */}
          {activeChallenges.length > 0 && <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold text-gray-900">
                {activeTab === 'active' && 'Active Challenges'}
                {activeTab === 'available' && 'Available Challenges'}
                {activeTab === 'past' && 'Past Challenges'}
              </h2>
              <div className="flex items-center">
                ...
                {activeTab === 'active' && <button onClick={() => setActiveTab('available')} className="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700">
                  ...
                  <div className="p-5">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {challenge.status === 'available' && <div className="bg-blue-100 text-blue-800 text-xs px-2 py-0.5 rounded-full">
                          Available
                        </div>}
                      {challenge.status === 'completed' && <div className="bg-purple-100 text-purple-800 text-xs px-2 py-0.5 rounded-full">
                          Completed
                        </div>}
                      {challenge.status === 'expired' && <div className="bg-gray-100 text-gray-800 text-xs px-2 py-0.5 rounded-full">
                          Expired
                        </div>}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        {challenge.rewards.coupon && <div className="ml-2 flex items-center">
                      ...
                      {challenge.status === 'available' && <button onClick={e => {
                  e.stopPropagation();
          ...
          {/* Challenge Calendar */}
          {activeTab === 'available' && <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-10">
          ...
          {/* Friend Activity */}
          {activeTab === 'active' && activeChallenges.length > 0 && <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-10">
      ...
      {showModal && selectedChallenge && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              {selectedChallenge.status === 'active' && selectedChallenge.progress !== undefined && <div className="mb-4">
                    <div className="flex items-center justify-between mb-2">
                          ...
                          {selectedChallenge.milestones.map((milestone, index) => <div key={index} className={`flex items-center p-2 rounded-md ${milestone.completed ? 'bg-green-50' : 'bg-gray-50'}`}>
                                ...
                                <div className="flex-grow">
                                  <p className={`text-sm ${milestone.completed ? 'text-green-700' : 'text-gray-700'}`}>
                                    ...
                                    {milestone.count}{' '}
                                    {selectedChallenge.type === 'check-in' ? 'check-ins' : selectedChallenge.type + 's'}
                                  </p>
                                </div>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-md p-4 mb-4">
                ...
                <div className="space-y-2">
                  ...
                  {selectedChallenge.rewards.coupon && <div className="flex items-center">
                      <TicketIcon className="w-4 h-4 text-purple-500 mr-2" />
                      <span className="text-blue-700">
                        {selectedChallenge.rewards.coupon.description} at{' '}
                        {selectedChallenge.rewards.coupon.businessName}
                      </span>
                    </div>}
                </div>
              </div>
              ...
              {selectedChallenge.status === 'completed' && <div className="bg-green-50 border border-green-100 rounded-md p-4 mb-4">
              ...
              {selectedChallenge.status === 'expired' && <div className="bg-gray-50 border border-gray-200 rounded-md p-4 mb-4">
              ...
              {selectedChallenge.leaderboard && selectedChallenge.leaderboard.length > 0 && <div className="mb-4">
                    <h4 className="font-medium text-gray-900 mb-2">
                        ...
                        {selectedChallenge.leaderboard.map(entry => <div key={entry.userId} className={`flex items-center justify-between p-2 rounded-md ${entry.isCurrentUser ? 'bg-blue-50' : 'bg-white'}`}>
                            <div className="flex items-center">
                              ...
                              <div className="text-sm">
                                <p className="font-medium text-gray-900">
                                  {entry.name}
                                  {entry.isCurrentUser && <span className="ml-1 text-xs text-blue-600">
                                      (You)
                                    </span>}
                                </p>
                              </div>

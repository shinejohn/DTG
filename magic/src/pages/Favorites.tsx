...
const mockFavorites: Business[] = [{
  ...
  category: 'Restaurants',
  subcategory: 'Bakery',
  image: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8cGFzdHJ5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  rating: 4.8,
  reviewCount: 210,
  priceRange: '$$',
  address: '101 Pine Street, Downtown',
  ...
  image: 'https://images.unsplash.com/photo-1505253716362-afaea1d3d1af?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cXVpbm9hJTIwc2FsYWR8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60',
  rating: 4.6,
  reviewCount: 156,
  priceRange: '$$$',
  address: '789 Elm Street, Downtown',
  tags: ['Vegan', 'Organic', 'Salads'],
  savedAt: '2023-07-05'
}, {
  id: 'b5',
  ...
  image: 'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2xvdGhpbmclMjBzdG9yZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
  rating: 4.3,
  reviewCount: 98,
  priceRange: '$$',
  address: '456 Fashion Ave, Downtown',
  tags: ['Vintage', 'Clothing', 'Accessories'],
  savedAt: '2023-06-20'
}, {
  id: 'b6',
  ...
  image: 'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Y2FmZSUyMHBhdGlvfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
  rating: 4.5,
  reviewCount: 187,
  priceRange: '$$',
...
const mockLists: CustomList[] = [{
  id: 'l1',
  name: 'Date Night',
  description: 'Perfect spots for a romantic evening',
  businessIds: ['b1', 'b3'],
  ...
  id: 'l2',
  name: 'Quick Lunch',
  description: 'Great places for a quick bite',
  ...
  description: 'Fun places to visit on weekends',
  businessIds: ['b2', 'b3', 'b5'],
...
export function Favorites() {
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* Create List Modal */}
      {isCreateListModalOpen && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">

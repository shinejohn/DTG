              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                ...
                <div className="p-6">
                    ...
                    <div className="mb-4 md:mb-0">
                      ...
                      <div className="flex items-center">
                        ...
                        <button
                          ...
                          className="ml-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md p-2"
                  ...
                  <div className="flex flex-wrap gap-2 mt-6">
                    ...
                    <button
                      onClick={openInviteModal}
                      className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-md text-sm font-medium flex items-center justify-center"
                    >
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                <div className="p-4 border-b flex items-center justify-between">
                  <h2 className="font-bold text-gray-900">
                    {activeTab === 'all' && 'All Referrals'}
                    {activeTab === 'pending' && 'Pending Referrals'}
                    {activeTab === 'successful' && 'Successful Referrals'}
                  </h2>
                  <button
          ...
          >
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                Share your unique referral link with friends and earn{' '}
                {stats.referralBonus} points for each successful referral.
              </p>
              <div className="mb-4">
                ...
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-3 rounded-r-md border border-l-0 border-gray-300"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <button
                      type="button"
                      onClick={closeInviteModal}
                      className="mr-2 bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-md text-sm font-medium"
                    >
                      Cancel
                    </button>
                    <button
                      ...
                      className={`bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium ${!inviteEmail ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                      Send Invite
                    </button>
                  </div>

...
const mockTransactions: PointTransaction[] = [{
  ...
  type: 'earned',
  amount: 50,
  description: 'Visited and reviewed',
  ...
  type: 'achievement',
  amount: 100,
  description: 'Earned "Photo Enthusiast" badge',
  ...
  type: 'spent',
  amount: -200,
  description: 'Redeemed coupon for',
...
const mockCoupons: Coupon[] = [{
  ...
  businessId: 'b1',
  businessName: 'Urban Bites Café',
  businessLogo: 'https://images.unsplash.com/photo-1544148103-0773bf10d330?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8Y2FmZSUyMGxvZ298ZW58MHx8MHx8&auto=format&fit=crop&w=100&q=60',
  ...
  businessId: 'b3',
  businessName: 'Downtown Bakery',
  businessLogo: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8cGFzdHJ5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=100&q=60',
  title: '25% Off Pastries',
  description: 'Enjoy 25% off all pastries before 11AM',
  discount: '25% OFF',
  category: 'Food & Drink',
  ...
  businessId: 'b2',
  businessName: 'City Cinema',
  businessLogo: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2luZW1hfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=100&q=60',
  title: 'Buy One Get One Movie Ticket',
  description: 'Purchase one ticket and get another free on Tuesdays',
  discount: 'BOGO',
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="md:hidden">
                          ...
                          <div className="ml-3 flex-grow">
                            <div className="flex items-center justify-between">
                              <p className="font-medium text-gray-900">
                                ...
                                {transaction.businessName && <Link to={`/business/${transaction.businessId}`} className="text-blue-600 hover:text-blue-800">
                    ...
                    {leaderboard.slice(0, 3).map(entry => <div key={entry.userId} className={`p-4 ${entry.isCurrentUser ? 'bg-blue-50' : ''}`}>
                        <div className="flex items-center">
                          ...
                          <div className="flex-grow">
                            <p className="font-medium text-gray-900">
                              {entry.name}
                              {entry.isCurrentUser && <span className="ml-2 text-xs bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full">
                                  You
                                </span>}
                            </p>
            ...
            {activeTab === 'coupons' && <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                <div className="p-4 border-b">
                  <h2 className="text-lg font-bold text-gray-900">
                    Available Rewards
                  </h2>

...
const mockUserProfile: UserProfile = {
  ...
  badges: [{
    id: 'b1',
    name: 'Elite Reviewer',
    description: 'Posted 25+ high-quality reviews',
    icon: 'award',
    earnedAt: '2022-05-10'
  }, {
    id: 'b2',
    ...
    id: 'b4',
    name: 'Trendsetter',
    description: 'Reviews received 200+ helpful votes',
    icon: 'trending-up',
    earnedAt: '2023-01-05'
  }, {
    id: 'b5',
    name: 'Coffee Connoisseur',
    description: 'Checked in at 15 different coffee shops',
    icon: 'coffee',
    earnedAt: '2022-09-18'
  }, {
    id: 'b6',
    ...
    description: 'Reached Gold tier in 3+ loyalty programs',
    icon: 'crown',
    earnedAt: '2023-02-28'
  }, {
    id: 'b8',
    name: 'First to Review',
    description: 'First to review 10+ new businesses',
    icon: 'zap',
    earnedAt: '2022-07-05'
  }],
  friends: [{
  ...
  reviews: [{
    ...
    businessImage: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8Y2FmZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
    rating: 5,
    content: "This place is amazing! The coffee is always perfectly brewed and the avocado toast is to die for. I love the atmosphere and the staff is always friendly. It's my go-to spot for meetings and catching up with friends.",
    photos: ['https://images.unsplash.com/photo-1525610553991-2bede1a236e2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8YnJlYWtmYXN0fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60'],
    helpfulVotes: 24,
    ...
    businessImage: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2luZW1hfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
    rating: 4,
    content: 'Great movie theater with comfortable seating and excellent sound quality. The concession stand is a bit pricey, but the overall experience is worth it. Will definitely be back!',
    photos: [],
    helpfulVotes: 12,
    ...
    businessImage: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8cGFzdHJ5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
    rating: 5,
    content: 'The pastries here are absolutely divine! Everything is fresh and made with high-quality ingredients. The chocolate croissants are my personal favorite. The staff is also incredibly friendly and helpful.',
    photos: ['https://images.unsplash.com/photo-1623334044303-241021148842?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hvY29sYXRlJTIwY3JvaXNzYW50fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60'],
    helpfulVotes: 18,
  ...
  photos: [{
    ...
    businessId: 'b1',
    businessName: 'Urban Bites Café',
    caption: 'Best avocado toast in town!',
    createdAt: '2023-07-15'
  }, {
    id: 'p2',
    url: 'https://images.unsplash.com/photo-1623334044303-241021148842?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Y2hvY29sYXRlJTIwY3JvaXNzYW50fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
    businessId: 'b3',
    businessName: 'Downtown Bakery',
    caption: 'Chocolate croissant perfection',
    createdAt: '2023-07-02'
  }, {
    id: 'p3',
    url: 'https://images.unsplash.com/photo-1559925393-8be0ec4767c8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Y2FmZSUyMHBhdGlvfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
    businessId: 'b1',
    businessName: 'Urban Bites Café',
    caption: 'Perfect spot for a sunny day',
    createdAt: '2023-06-18'
  }, {
    id: 'p4',
    url: 'https://images.unsplash.com/photo-1541167760496-1628856ab772?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8bGF0dGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60',
    businessId: 'b1',
    businessName: 'Urban Bites Café',
    caption: 'Their specialty latte is amazing',
  ...
  // New mock data for rewards and loyalty
  rewardsSummary: {
    pointsBalance: 2450,
    lifetimePoints: 5680,
    level: 'Gold Explorer',
    ...
    recentPointsActivity: [{
      ...
      amount: 50,
      type: 'earned',
      source: 'Review at Urban Bites Café',
      date: '2023-07-15'
    }, {
      id: 'pa2',
      amount: 25,
      type: 'earned',
      source: 'Check-in at City Cinema',
      date: '2023-07-15'
    }, {
      id: 'pa3',
      amount: 200,
      type: 'spent',
      source: 'Free Coffee Reward',
      date: '2023-07-12'
    }, {
      id: 'pa4',
      amount: 75,
      type: 'earned',
      source: 'Achievement: Photo Enthusiast',
      date: '2023-07-10'
    }, {
      id: 'pa5',
      amount: 100,
  ...
  achievements: [{
    ...
    description: 'Upload 150 photos of businesses',
    icon: 'camera',
    progress: 156,
    total: 150,
    completed: true,
    ...
    description: 'Check in at 20 different coffee shops',
    icon: 'coffee',
    progress: 15,
    total: 20,
    completed: false,
    ...
    id: 'ach5',
    name: 'Helpful Guru',
    description: 'Receive 250 helpful votes on your reviews',
    icon: 'thumbs-up',
    progress: 215,
    total: 250,
    completed: false,
    ...
    id: 'ach6',
    name: 'Loyalty Master',
    description: 'Reach top tier in 5 loyalty programs',
    icon: 'crown',
    progress: 2,
    total: 5,
    completed: false,
  ...
  loyaltyMemberships: [{
    ...
    perks: ['Free drink every 10 visits', '10% off on weekdays', 'Priority seating', 'Exclusive tastings']
  }, {
    id: 'lm2',
    businessId: 'b3',
    businessName: 'Downtown Bakery',
    ...
    perks: ['Free pastry on birthday', '5% off all purchases']
  }, {
    id: 'lm3',
    businessId: 'b4',
    businessName: 'Riverside Books',
    businessImage: 'https://images.unsplash.com/photo-1526243741027-444d633d7365?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fGJvb2tzdG9yZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
    tier: 'Bronze',
    pointsBalance: 150,
    memberSince: '2023-01-10',
    perks: ['$5 reward for every $100 spent']
  }],
  leaderboardPosition: {
    rank: 7,
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        <div className="relative h-[200px] md:h-[300px] overflow-hidden">
          ...
          {/* Profile actions - only visible if it's the user's own profile */}
          {isCurrentUser && <div className="absolute top-4 right-4 flex space-x-2">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative -mt-20 mb-6">
            <div className="bg-white rounded-lg shadow-sm p-6 pt-24 relative">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  <div className="flex items-center">
                    ...
                    {/* Add level badge */}
                    {profile.rewardsSummary && <span className="ml-2 bg-amber-100 text-amber-800 text-xs px-2 py-0.5 rounded-full flex items-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mt-6 pt-6 border-t">
                ...
                {/* Add points to statistics */}
                {profile.rewardsSummary && <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-10">
            ...
            <div className="md:w-2/3">
              ...
              <div className="bg-white rounded-lg shadow-sm mb-6 overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  {/* Rewards Tab */}
                  {activeTab === 'rewards' && profile.rewardsSummary && <div className="space-y-6">
                      {/* Rewards Summary */}
                      ...
                      {/* Loyalty Memberships */}
                      {profile.loyaltyMemberships && profile.loyaltyMemberships.length > 0 && <div className="bg-white border rounded-lg p-4">
                            <h3 className="text-lg font-semibold mb-3">
                  ...
                  {/* Achievements Tab */}
                  {activeTab === 'achievements' && profile.achievements && <div className="space-y-6">
            ...
            <div className="md:w-1/3 space-y-6">
              {/* Rewards Summary - Added to sidebar */}
              {profile.rewardsSummary && <div className="bg-white rounded-lg shadow-sm p-4">
              ...
              {profile.leaderboardPosition && <div className="bg-white rounded-lg shadow-sm p-4">
                  <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="space-y-3">
                    ...
                    {profile.leaderboardPosition.friendsBehind.length > 0 && <div>
                        <h3 className="text-sm font-medium text-gray-700 mb-2">
                          Friends Behind
                        </h3>
              ...
              {/* Achievement Highlights - New */}
              {profile.achievements && <div className="bg-white rounded-lg shadow-sm p-4">
                  <div className="flex items-center justify-between mb-4">
      ...
      <Footer />
      {/* Message Modal */}
      {isMessageModalOpen && <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">

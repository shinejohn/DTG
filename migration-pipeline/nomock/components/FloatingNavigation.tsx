...
export function FloatingNavigation() {
  ...
  return <>
      ...
      <SocialShareModal isOpen={isShareModalOpen} onClose={closeShareModal} title="Downtown Guide" description="Check out this awesome local guide app!" url={window.location.href} imageUrl="/images/placeholder.jpg" />
    </>;
}
                          ...
                          <div className="mb-4">
                            ...
                            <div className="flex items-center justify-between mt-2 text-sm text-gray-500">
                              <div className="flex items-center">
                                ...
                                <span>
                                  {formatDate(activeChallenge.startDate)} -{' '}
                                  {formatDate(activeChallenge.endDate)}
                                </span>
                              </div>
                              <div className="flex items-center">
                            ...
                            <div className="space-y-2">
                              {activeChallenge.leaderboard.map(
                                (entry, index) => (
                                  <div
                                    key={entry.userId}
                                    className={`flex items-center justify-between p-2 rounded-md ${entry.isCurrentUser ? 'bg-blue-50' : 'bg-gray-50'}`}
                                  >
                                    <div className="flex items-center">

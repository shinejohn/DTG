    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-grow flex">
        ...
        <main className="flex-grow p-4 md:p-6">
          ...
          {business.completionPercentage < 100 && (
          ...
          <div className="md:hidden mb-6 border-b">
            <div className="flex overflow-x-auto">
              <button
                ...
                className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'overview' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
              >
                Overview
              </button>
              <button
                onClick={() => setActiveTab('reviews')}
                className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'reviews' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
              >
                Reviews
              </button>
              <button
                onClick={() => setActiveTab('insights')}
                className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'insights' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
              >
                Insights
              </button>
              <button
                onClick={() => setActiveTab('loyalty')}
                className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'loyalty' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
              >
                Loyalty
              </button>
              <button
                onClick={() => setActiveTab('actions')}
                className={`px-4 py-2 font-medium whitespace-nowrap ${activeTab === 'actions' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
              >
                Actions
              </button>
            </div>
                ...
                <div className="flex flex-wrap items-center justify-between mb-4">
                  ...
                  <div className="flex space-x-2 mt-2 sm:mt-0">
                    <button
                      ...
                      className={`px-3 py-1 text-sm rounded-md ${selectedMetric === 'views' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'}`}
                    >
                      Profile Views
                    </button>
                    <button
                      onClick={() => setSelectedMetric('calls')}
                      className={`px-3 py-1 text-sm rounded-md ${selectedMetric === 'calls' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'}`}
                    >
                      Calls
                    </button>
                    <button
                      onClick={() => setSelectedMetric('directions')}
                      className={`px-3 py-1 text-sm rounded-md ${selectedMetric === 'directions' ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'}`}
                    >
                      Directions
                    </button>
                  </div>
            ...
            <div className="mb-8">
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                <div className="border-b">
                  <nav className="flex">
                    <button
                      onClick={() => setActiveLoyaltyTab('coupons')}
                    ...
                    <button
                      onClick={() => setActiveLoyaltyTab('program')}
                      className={`px-4 py-3 font-medium text-sm flex-1 text-center ${
                    ...
                    <button
                      onClick={() => setActiveLoyaltyTab('achievements')}
                      className={`px-4 py-3 font-medium text-sm flex-1 text-center ${
                    ...
                    <button
                      onClick={() => setActiveLoyaltyTab('roi')}
                      className={`px-4 py-3 font-medium text-sm flex-1 text-center ${
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-green-700">
                            Your loyalty program is generating a positive ROI of{' '}
                            {mockRewardProgramROI.roiPercentage}%. The program
                            has increased average order value by{' '}
                            {mockRewardProgramROI.averageOrderValueChange}% and
              ...
              {filteredSuggestions.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredSuggestions.map((suggestion) => (
                    <div
                      key={suggestion.id}
                      className="bg-white rounded-lg shadow-sm p-4 border-l-4 border-l-blue-500"
                    >
                      <div className="flex justify-between">
                        <div
              ...
              <div>
                ...
                <div className="mb-4 border-b">
                  <div className="flex overflow-x-auto">
                    <button
                      onClick={() => setActiveLoyaltyTab('coupons')}
                      className={`px-3 py-2 font-medium whitespace-nowrap text-sm ${activeLoyaltyTab === 'coupons' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
                    >
                      Coupons
                    </button>
                    <button
                      onClick={() => setActiveLoyaltyTab('program')}
                      className={`px-3 py-2 font-medium whitespace-nowrap text-sm ${activeLoyaltyTab === 'program' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
                    >
                      Program
                    </button>
                    <button
                      onClick={() => setActiveLoyaltyTab('achievements')}
                      className={`px-3 py-2 font-medium whitespace-nowrap text-sm ${activeLoyaltyTab === 'achievements' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
                    >
                      Achievements
                    </button>
                    <button
                      onClick={() => setActiveLoyaltyTab('roi')}
                      className={`px-3 py-2 font-medium whitespace-nowrap text-sm ${activeLoyaltyTab === 'roi' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
                    >
                      ROI
                    </button>
                  </div>

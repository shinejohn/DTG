-- =========================================================================
-- DOWNTOWN GUIDE - DATABASE INDEXES (SIMPLIFIED)
...
-- This is a simplified version without partial indexes or DESC ordering
...
CREATE INDEX IF NOT EXISTS idx_deals_code ON public.deals(promo_code);
...
CREATE INDEX IF NOT EXISTS idx_user_favorites_event ON public.user_favorites(event_id);
CREATE INDEX IF NOT EXISTS idx_user_favorites_article ON public.user_favorites(article_id);
CREATE INDEX IF NOT EXISTS idx_user_favorites_deal ON public.user_favorites(deal_id);
...
CREATE INDEX IF NOT EXISTS idx_user_collections_public ON public.user_collections(is_public);
